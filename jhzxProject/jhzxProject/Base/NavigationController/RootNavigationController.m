...
+ (void)initialize
{
    ...
    [navBar setTitleTextAttributes:@{NSForegroundColorAttributeName :YYNavigateTitleColor, NSFontAttributeName : [UIFont systemFontOfSize:18.f weight:UIFontWeightBold]}];
